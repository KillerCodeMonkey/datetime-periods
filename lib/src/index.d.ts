...
/**
   ...
   */
export declare const getDateTimeObject: (date: Date) => DateTimeObject;
/**
   ...
   */
export declare const getDateTimePeriods: (value?: Date, min?: Date, max?: Date, needed?: NeededPeriods) => GetDateTimePeriods;
